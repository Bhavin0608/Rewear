...
<head>
    ...
    <style>
        ...
        * {
        ...
        .register-form .form-control:focus + .form-label,
        .register-form .form-control:not(:placeholder-shown) + .form-label {
            top: -10px;
            left: 2.5rem;
            font-size: 0.8rem;
        ...
        .register-form .form-control:focus ~ .form-icon {
...
<body>
    ...
    <div class="register-card">
        ...
        <p class="subtitle">Join the ReWear sustainable fashion community.</p>
        ...
        <form action="../php/auth.php" method="POST" class="register-form">
